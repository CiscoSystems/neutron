...
neutron_router_db = [{'_floatingips':
        ...
        [{'admin_state_up': True,
          ...
          'ha_info': {'group': '1064',
                                 'ha_port': {'admin_state_up': True,
                                              ...
                                              'extra_dhcp_opts': [],
                                              'extra_subnets': [],
                                              'fixed_ips': [{'ip_address': '20.20.20.1',
                                                              'prefixlen': 24,
                                                              'subnet_id': '90c10f81-47f2-487c-ad1b-c7212c378e08'}],
                                 ...
                                 'tracking_config': '',
                                 'type': 'HSRP'},
                    'hosting_info': {'hosting_mac': 'fa:16:3e:4f:33:fb',
  ...
  'cisco_ha:details': {'priority': 100,
                        ...
                        'redundancy_level': 1,
                        'redundancy_routers': [{'id': 'e7f8b39b-2d87-4eb7-9102-fd24eb3a2416',
                                                 'priority': 97,
                                                 'state': 'STANDBY'}],
                        'state': 'ACTIVE',
                        'type': 'HSRP'},
  'cisco_ha:enabled': True,
  'external_gateway_info': {'external_fixed_ips': [{'ip_address': '172.16.0.116',
                                                      'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                             'network_id': '7a38a5fd-3ad9-4952-ab08-4def22407269'},
  'gw_port': {'admin_state_up': True,
               'allowed_address_pairs': [],
               'binding:host_id': 'asr1k-k7-controller-1-R2',
               'binding:profile': {},
               'binding:vif_details': {'ovs_hybrid_plug': True,
               ...
               'extra_dhcp_opts': [],
               'extra_subnets': [],
               'fixed_ips': [{'ip_address': '172.16.0.116',
                               'prefixlen': 16,
                               'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
               'ha_info': {'group': '1064',
                            'ha_port': {'admin_state_up': True,
                            ...
                            'tracking_config': '',
                            'type': 'HSRP'},
               'hosting_info': {'hosting_mac': 'fa:16:3e:ef:c0:88',
  ...
  'name': 'ROUTER1',
  'router_type': {'cfg_agent_driver': 'neutron.plugins.cisco.cfg_agent.device_drivers.asr1k.asr1k_routing_driver.ASR1kRoutingDriver',
  ...
  'status': 'ACTIVE',
  'tenant_id': '2386c5d814814fb68b037ab7aec784f8'},
 {'_floatingips': [{'fixed_ip_address': '10.2.0.5',
  ...
  '_interfaces': [{'admin_state_up': True,
                    'allowed_address_pairs': [],
                    'binding:host_id': 'asr1k-k7-controller-1-R2',
                    'binding:profile': {},
                    'binding:vif_details': {'ovs_hybrid_plug': True,
                    ...
                    'ha_info': {'group': '1064',
                                 ...
                                 'tracking_config': '',
                                 'type': 'HSRP'},
                    'hosting_info': {'hosting_mac': 'fa:16:3e:69:50:00',
  ...
  'cisco_ha:details': {'priority': 100,
                        'probe_connectivity': False,
                        'redundancy_level': 1,
                        'redundancy_routers': [{'id': '3ea5f9f9-0ecf-4595-b8be-3f340f2c82e3',
                                                 'priority': 97,
                                                 'state': 'STANDBY'}],
                        'state': 'ACTIVE',
                        'type': 'HSRP'},
  'cisco_ha:enabled': True,
  'external_gateway_info': {'external_fixed_ips': [{'ip_address': '172.16.0.125',
                                                      'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                             'network_id': '7a38a5fd-3ad9-4952-ab08-4def22407269'},
  'gw_port': {'admin_state_up': True,
               'allowed_address_pairs': [],
               ...
               'extra_dhcp_opts': [],
               'extra_subnets': [],
               'fixed_ips': [{'ip_address': '172.16.0.125',
                               'prefixlen': 16,
                               'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
               'ha_info': {'group': '1064',
                            'ha_port': {'admin_state_up': True,
                                         ...
                                         'extra_dhcp_opts': [],
                                         'extra_subnets': [],
                                         'fixed_ips': [{'ip_address': '172.16.0.124',
                                                         'prefixlen': 16,
                                                         'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                            ...
                            'tracking_config': '',
                            'type': 'HSRP'},
               'hosting_info': {'hosting_mac': 'fa:16:3e:4c:47:f2',
  ...
  'status': 'ACTIVE',
  'tenant_id': ''},
 {'_floatingips': [{'fixed_ip_address': '192.168.0.9',
  ...
  '_interfaces': [{'admin_state_up': True,
                    ...
                    'ha_info': {'group': '1064',
                                 ...
                                 'tracking_config': '',
                                 'type': 'HSRP'},
                    'hosting_info': {'hosting_mac': 'fa:16:3e:e8:a3:24',
  ...
  'cisco_ha:details': {'priority': 100,
                        'probe_connectivity': False,
                        'redundancy_level': 1,
                        'redundancy_routers': [{'id': 'ea0f1fde-e00f-49f1-aa60-6e30c1197ea5',
                                                 'priority': 97,
                                                 'state': 'STANDBY'}],
                        'state': 'ACTIVE',
                        'type': 'HSRP'},
  'cisco_ha:enabled': True,
  'external_gateway_info': {'external_fixed_ips': [{'ip_address': '172.16.0.101',
                                                      'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                             'network_id': '7a38a5fd-3ad9-4952-ab08-4def22407269'},
  'gw_port': {'admin_state_up': True,
               'allowed_address_pairs': [],
               ...
               'extra_dhcp_opts': [],
               'extra_subnets': [],
               'fixed_ips': [{'ip_address': '172.16.0.101',
                               'prefixlen': 16,
                               'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
               'ha_info': {'group': '1064',
                            'ha_port': {'admin_state_up': True,
                            ...
                            'tracking_config': '',
                            'type': 'HSRP'},
               'hosting_info': {'hosting_mac': 'fa:16:3e:96:ed:91',
 ...
 {'admin_state_up': True,
  'cisco_ha:details': {'priority': 100,
                        'probe_connectivity': False,
                        'redundancy_level': 2,
                        'redundancy_routers': [{'id': '213fd355-78c3-44cc-bd6e-492b9ade2602',
                                                 'priority': 97,
                                                 'state': 'STANDBY'},
                        ...
                        'type': 'HSRP'},
  'cisco_ha:enabled': True,
  'external_gateway_info': {'external_fixed_ips': [{'ip_address': '172.16.0.105',
                                                      'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                             'network_id': '7a38a5fd-3ad9-4952-ab08-4def22407269'},
  'gw_port': {'admin_state_up': True,
               'allowed_address_pairs': [],
               ...
               'extra_dhcp_opts': [],
               'extra_subnets': [],
               'fixed_ips': [{'ip_address': '172.16.0.105',
                               'prefixlen': 16,
                               'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
               'ha_info': {'group': '1064',
                            'ha_port': {'admin_state_up': True,
                                         ...
                                         'extra_dhcp_opts': [],
                                         'extra_subnets': [],
                                         'fixed_ips': [{'ip_address': '172.16.0.104',
                                                         'prefixlen': 16,
                                                         'subnet_id': '8f9c885d-a2ad-4fff-8127-2d4b3af6015b'}],
                            ...
                            'tracking_config': '',
                            'type': 'HSRP'},
               'hosting_info': {'hosting_mac': 'fa:16:3e:97:ec:f2',
...
# print(pp.pformat(neutron_router_db))

with open('result.json', 'w') as fp:
    json.dump(neutron_router_db, fp)
