...
DATA_FILE = 'asr_running_cfg.json'
...
asr_running_cfg = ['!',
 ...
 'ip nat pool nrouter-92740e-0000002_nat_pool 172.16.0.101 172.16.0.101 netmask 255.255.0.0',
 'ip nat pool nrouter-bdc5b5-0000002_nat_pool 172.16.0.116 172.16.0.116 netmask 255.255.0.0',
 'ip nat pool nrouter-3ea5f9-0000002_nat_pool 172.16.0.124 172.16.0.124 netmask 255.255.0.0',
 ...
 'ip nat inside source static 192.168.0.9 172.16.0.109 vrf nrouter-92740e-0000002 redundancy neutron-hsrp-1064-3000',
 'ip nat inside source static 20.20.20.5 172.16.0.118 vrf nrouter-bdc5b5-0000002 redundancy neutron-hsrp-1064-3000',
 'ip nat inside source static 20.20.20.7 172.16.0.120 vrf nrouter-bdc5b5-0000002 redundancy neutron-hsrp-1064-3000',
 'ip nat inside source static 10.2.0.5 172.16.0.126 vrf nrouter-3ea5f9-0000002 redundancy neutron-hsrp-1064-3000',
 'ip nat inside source list neutron_acl_0000002_2564 pool nrouter-3ea5f9-0000002_nat_pool vrf nrouter-3ea5f9-0000002 overload',
 'ip nat inside source list neutron_acl_0000002_2535 pool nrouter-92740e-0000002_nat_pool vrf nrouter-92740e-0000002 overload',
 ...
 'ip nat inside source list neutron_acl_0000002_2577 pool nrouter-bdc5b5-0000002_nat_pool vrf nrouter-bdc5b5-0000002 overload',
 ...
 'ip route vrf nrouter-92740e-0000002 0.0.0.0 0.0.0.0 Port-channel10.3000 172.16.0.1',
 'ip route vrf nrouter-bdc5b5-0000002 0.0.0.0 0.0.0.0 Port-channel10.3000 172.16.0.1',
 'ip route vrf nrouter-3ea5f9-0000002 0.0.0.0 0.0.0.0 Port-channel10.3000 172.16.0.1',
