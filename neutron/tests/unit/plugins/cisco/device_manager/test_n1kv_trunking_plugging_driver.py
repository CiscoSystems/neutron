    ...
    def test_delete_hosting_device_resources_retry_success(self):
        ...
        with mock.patch.object(plugging_driver, '_delete_resources') as (
            ...
            with mock.patch(
                    ...
                    'n1kv_ml2_trunking_driver.eventlet.sleep'):
        ...
        with self.subnet() as subnet1:
            ...
            with self.router(external_gateway_info=gw_info,
                ...
                with contextlib.nested(
                    mock.patch.object(self.core_plugin, 'get_network'),
                    mock.patch.object(self.core_plugin, 'get_networks')) as (
                        m1, m2):
                    ...
                    for i in xrange(1, len(test_info1['network_types'])):
                        cidr = '1.0.' + str(i) + '.0/24'
                    ...
                    with self.router(external_gateway_info=gw_info,
                        ...
                        for i in xrange(1, len(test_info2['network_types'])):
                            cidr = '2.0.' + str(i) + '.0/24'
